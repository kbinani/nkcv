...
security import ./scripts/certs/cert.cer -k ~/Library/Keychains/nkcv-build.keychain -T /usr/bin/codesign
security import ./scripts/certs/cert.p12 -k ~/Library/Keychains/nkcv-build.keychain -P $CERTS_PASS -T /usr/bin/codesign
